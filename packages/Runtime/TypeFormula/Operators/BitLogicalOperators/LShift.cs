...
namespace Katuusagi.GenericEnhance
{
    public struct LShift<T, TX, TY> :
        ...
        where TY : struct, ITypeFormula<int>
    {
        public static readonly T ResultValue = BitLogicalUtils.LShift(TypeFormula.GetValue<TX, T>(), TypeFormula.GetValue<TY, int>());
