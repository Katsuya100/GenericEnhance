...
namespace Katuusagi.GenericEnhance
{
    ...
    {
        public static readonly T ResultValue = BitLogicalUtils.Not(TypeFormula.GetValue<TX, T>());
        ...
        public static readonly float FloatResultValue = CastUtils.Cast<T, float>(ResultValue);
